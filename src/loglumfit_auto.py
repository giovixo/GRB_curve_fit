...
#infile='testgrb.dat'
#infile='ShortGRB.dat'
infile='Long_GoldenGRB.dat'
#infile='Long_GoldenGRB_EV.dat'
...
#path1="./output/LGRB_golden_Tt_EV_23a1/"
#path1="./output/LGRB_golden_Tt_EV_Pfree/"
#path1="./output/LGRB_golden_Tt_EV_thetajet/"
#path1="./output/LGRB_golden_Tt_EV_thetajet_k4/"
#path1="./output/LGRB_golden_Tt_EV_thetajet_k4_isoNS_new/"
#path1="./output/LGRB_golden_Tt_EV_thetajet_k4_new/"
#path1="./output/LGRB_golden_Tt_EV_thetajet_k4_newE01/"
path1="./output/LGRB_golden_Tt_EV_thetajet_k4_new/"
#path1="./output/test/"
#path1="./output/SGRB_Tt/"
#path1="./output/SGRB_Tt_EV/"
#path1="./output/SGRB_Tt_EV_thetajet/"
#path1="./output/SGRB_Tt_EV_thetajet_k4_isoNS/"
#path1="./output/SGRB_Tt_EV_thetajet_k1/"

#pathtest="./output/SGRB_Tt_EV_thetajet/"



print '  !!!!!!!!'
print ''
print ' This code computes the best fit model for each GRB read in input from: '
print ''
print '  Input file:',path+infile
print ''
print '...and writes output files into the output dir:'
print ''
print '  Output:',path1
print ''
print '  !!!!!!!!'
...
# Energia del getto (cinetica) in 10^51 erg (o 10^52 erg??)
# ---
...
#outfileold=path1+"oldmodel_E"+str(E0old)+".txt"
#outfilenewx=path1+"newmodel_alphafix_E"+str(E0newa)+".txt"
...
# Leggo e correggo i dati per ciascun GRB
...
for fi in listgrb:
    ...
    z=float(datafiflat[1])          # GRB redshift
    beta=float(datafiflat[2])       # spectral index
    dbeta=float(datafiflat[3])      # error on spectral index
    Tt=float(datafiflat[5])         # log Tstart (obs. frame) del plateau
    ...
    # --- legge l'energia E0 = Initial total energy (10^51 erg ??)
    ...
    En1=str(E1)
    En2=str(E2)
    plt.title('GRB'+fi+' ['+En1+'-'+En2+' keV]'+' E052='+str(E0old))
    ...
    plt.xlabel('rest frame time from trigger [s]')
    plt.ylabel('log Luminosity [10^51 erg s^-1]')
    plt.show()
    ...
    def model_old(logt,k,B,omi):
        ...
        (Dall'Osso et al. 2011) assuming pure magnetic dipole, as function of
            ...
            [E0old is defined as a constant above]
        ...
        #a1=(2./3.)*(3.799*10.**6.)/(B**2.*omi**2.)
        #a1=(2./3.)*(I*c**3./r0**6.)/(B**2.*omi**2.)
    ...
    def fitmodelold(model, x, y, dy):
        ...
        p0=np.array([k,B,omi])
        #popt, pcov = curve_fit(model, x, y, p0, sigma=dy, bounds=([0.0001,1.e-3,0.05], [4.0, 1000.,10.5]),maxfev=10000)
        ...
        print " E051=(L(startTxrt))*startTxrt/k=",10**(model(np.log10(startTxrt),popt[0],popt[1],popt[2]))*startTxrt/popt[0]
        print "------  "
    ...
    #    ym=model(x,popt[0],popt[1],popt[2],popt[3])
        ...
        print "dof=", dof
        p_value = 1.0-stats.chi2.cdf(x=mychi,df=dof)
